...
export function LotteryCard({
  ...
  return (
    <Link href={`/lottery/${slug}`} className="block h-full">
      <Card className="group hover:-translate-y-1 transition-all duration-300 border-zinc-800 bg-zinc-900/90 backdrop-blur-sm overflow-hidden h-full">
