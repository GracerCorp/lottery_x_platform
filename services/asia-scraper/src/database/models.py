import uuid
from sqlalchemy import Column, Integer, String, Boolean, JSON, Date, DateTime, Numeric, ForeignKey, Text
...
class ScraperJob(Base):
    """Scraper job execution tracking (new table for Python scraper)"""
...
class ScraperConfig(Base):
    """Scraper configuration (new table for Python scraper)"""
