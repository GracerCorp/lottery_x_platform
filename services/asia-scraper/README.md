...
A comprehensive Python-based lottery scraping service for Asian countries, featuring CRON scheduling, database integration, and a RESTful API.

## Features

- **Pan-Asian Coverage**: Supports 13+ lottery configurations across 10 Asian countries
...
### Major Countries
- 🇮🇳 India: Kerala State Lottery, Sikkim State Lottery
- 🇸🇬 Singapore: TOTO, 4D
...
```python
{
    "name": "Singapore TOTO",
    "slug": "sg-toto",
    "schedule": "0 12 * * 1,4",  # Mon, Thu at 12 PM UTC (8 PM SGT)
}
```
